...
enum L10n {
    static let en: [String: String] = [
        ...
        "status.performanceTitle": "Remote performance",
        "status.performanceChecking": "Reading performance over SSH…",
        "status.processorLoad": "Processor Load",
        "status.ramUsage": "RAM Usage",
        "status.ramValue": "%d%% · %@ / %@",
        "status.performanceHostDown": "Remote host unavailable",
    ...
    static let zh: [String: String] = [
        ...
        "status.performanceTitle": "远端性能",
        "status.performanceChecking": "正在通过 SSH 读取性能…",
        "status.processorLoad": "处理器负载",
        "status.ramUsage": "内存占用",
        "status.ramValue": "%d%% · %@ / %@",
        "status.performanceHostDown": "远端主机不可达",
